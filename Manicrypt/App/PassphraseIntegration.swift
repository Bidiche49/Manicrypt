...
struct PassphraseWindowManager {
    ...
    private static func showWindow<Content: View>(content: Content, size: NSSize = NSSize(width: 400, height: 600)) {
        ...
        window.title = "Manicrypt - Passphrase Generator"
...
// MARK: - Integration with ManicryptView
extension ManicryptView {
    /// Add this to the main ManicryptView to provide quick access to passphrase generator
